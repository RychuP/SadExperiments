...
namespace SadExperiments.UI.Controls
{
    ...
    /// </summary>
    [DataContract]
    public class ModifiedTextBox : ControlBase
    {
        ...
        #region Constructors
        static ModifiedTextBox() =>
            Library.Default.SetControlTheme(typeof(ModifiedTextBox), new TextBoxTheme());

        /// <summary>
        /// Creates a new instance of the input box.
        /// </summary>
        /// <param name="width">The width of the input box.</param>
        public ModifiedTextBox(int width)
            : base(width, 1)
        {
        }
        #endregion
        ...
        private bool TriggerKeyPressEvent(AsciiKey key)
        {
            if (KeyPressed == null)
                return false;
