...
namespace SadExperiments.Pages.GoRoguePages;

internal class LineAlgorithms : Page
{
    ...
    class LineSurface : ScreenSurface
    {
        ...
        public Lines.Algorithm CurrentAlgorithm;
        ...
        {
            Surface.Clear();
            var linePoints = Lines.Get(start, end, CurrentAlgorithm);
        ...
        public void ChangeAlgorithm()
        {
            ...
            CurrentAlgorithm = Enum.IsDefined(typeof(Lines.Algorithm), i) ? (Lines.Algorithm)i : 0;
        }
    }
