...
class PageCounter : ScreenSurface
{
    ...
    readonly string _hyphens = new('-', MaxNumberLength);
    ...
    {
        if (Container.Instance.CurrentPage is ContentsList)
        {
        ...
        else
        {
            ...
            int pageNumber = Container.Instance.CurrentPage.Index + 1;
    ...
    {
        _pageCount = Container.Instance.PageList.Length;
